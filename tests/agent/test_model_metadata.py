...
class TestExtractPricingDictValues:
    """Regression coverage for Venice-style nested pricing payloads."""
    ...
    def test_fetch_endpoint_model_metadata_venice_shape(self):
        ...
        assert metadata["zai-org-glm-5-2"]["context_length"] == 1_000_000
        assert metadata["z-ai-glm-5-turbo"]["context_length"] == 200_000
        assert metadata["zai-org-glm-5-2"]["pricing"]["prompt"] == {
            "usd": 1.4,
            "diem": 1.4,
        }
